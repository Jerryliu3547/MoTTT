 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "print(f\"\\nBaseline Accuracy on First {len(records)} Samples: {accuracy:.1f}% ({correct}/{len(records)})\")\n",
    "\n",
    "output_data = {\n",
    ...
    "}\n",
    "output_path = \"/content/drive/MyDrive/MoTTT/baseline_eval_results.json\" if os.path.exists(\"/content/drive/MyDrive/MoTTT\") else \"/content/baseline_eval_results.json\"\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        \n",
    "    accuracy = correct/len(records)*100\n",
    "    print(f\"\\nMoTTT Accuracy on First {len(records)} Samples: {accuracy:.1f}% ({correct}/{len(records)})\")\n",
    "\n",
    "    output_data = {\n",
    "        'model': 'MoTTT-Enhanced-Qwen2.5-Math-1.5B',\n",
    "        'accuracy': accuracy,\n",
    "        'correct_count': correct,\n",
    "        'total_samples': len(records),\n",
    "        'results': mottt_results\n",
    "    }\n",
    "    output_path = \"/content/drive/MyDrive/MoTTT/mottt_eval_results.json\" if os.path.exists(\"/content/drive/MyDrive/MoTTT\") else \"/content/mottt_eval_results.json\"\n",
    "    with open(output_path, 'w', encoding='utf-8') as f:\n",
    "        json.dump(output_data, f, indent=2, ensure_ascii=False)\n",
    "    print(f\"Saved MoTTT results to {output_path}\")\n",
    "else:\n",
